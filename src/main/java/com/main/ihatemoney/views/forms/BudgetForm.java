...
import com.main.ihatemoney.data.converter.BigDecimalToDoubleConverter;
import com.main.ihatemoney.data.converter.SqlDateToLocalDateConverter;
...
public class BudgetForm extends FormLayout {
    ...
    public BudgetForm(SecurityService securityService, PfmService service) {
        ...
        budgetBinder.forField(startDatePick)
                ...
                .bind(Budget::getStartDate, Budget::setStartDate);
        ...
        budgetBinder.forField(endDatePick)
                ...
                .bind(Budget::getEndDate, Budget::setEndDate);
