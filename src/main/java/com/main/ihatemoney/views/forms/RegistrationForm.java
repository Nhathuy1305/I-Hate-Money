...
public class RegistrationForm extends FormLayout implements RouterLayout {
    ...
    public RegistrationForm() {
        ...
        title = new H3("Create a new IHateMoney account");
        ...
        allowMarketing = new Checkbox("Subscribe to marketing email?");
        ...
        add(formHeader, firstName, lastName, email, password, passwordConfirmation, allowMarketing, errorMessage, submit, toLogin);
