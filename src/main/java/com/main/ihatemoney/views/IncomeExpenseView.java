...
@PageTitle("I & E | IHateMoney")
@PermitAll
@CssImport(value = "./themes/ihatemoney/charts.css", themeFor = "vaadin-chart")
@CssImport(value = "./themes/ihatemoney/views/i-v-e.css")
public class IncomeExpenseView extends Div {
    ...
    public IncomeExpenseView(SecurityService securityService, PfmService service) {
